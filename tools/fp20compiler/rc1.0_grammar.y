...
FinalMappedRegister : Register
		{
			MappedRegisterStruct reg;
			reg.Init($1, MAP_UNSIGNED_IDENTITY);
			$$ = reg;
		}
		| unsignedString openParen Register closeParen
		{
